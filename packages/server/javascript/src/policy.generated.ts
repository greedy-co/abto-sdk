...
export const DIRECT_HEADER_NAMES: ReadonlySet<string> = new Set(['accept', 'content-type', 'idempotency-key', 'traceparent', 'tracestate', 'user-agent']);
...
export const PROVIDER_IDS = ['openai', 'anthropic', 'gemini', 'deepseek', 'kimi'] as const;
...
export const ERROR_SOURCE_PROVIDER = "provider" as const;
export const ERROR_SOURCE_TRANSPORT = "transport" as const;
export const ERROR_SOURCE_GATEWAY = "gateway" as const;
