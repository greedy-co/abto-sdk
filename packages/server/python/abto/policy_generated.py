...
DIRECT_HEADER_NAMES: Final[FrozenSet[str]] = frozenset({"accept", "content-type", "idempotency-key", "traceparent", "tracestate", "user-agent"})
DIRECT_HEADER_PREFIXES: Final[Tuple[str, ...]] = ("openai-", "x-stainless-",)
SAFE_GATEWAY_STATUSES: Final[FrozenSet[int]] = frozenset({502, 503, 504})
PROVIDER_IDS: Final[Tuple[str, ...]] = ("openai", "anthropic", "gemini", "deepseek", "kimi",)
...
HEADER_ERROR_SOURCE: Final[str] = "x-abto-error-source"
ERROR_SOURCE_PROVIDER: Final[str] = "provider"
ERROR_SOURCE_TRANSPORT: Final[str] = "transport"
ERROR_SOURCE_GATEWAY: Final[str] = "gateway"
