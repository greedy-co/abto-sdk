...
const abtoCustomMetricFields = <String>{'value', 'scale'};
const abtoMetricAbsoluteLimit = 1e+38;
const abtoMetricMaxFractionDigits = 12;
...
const abtoErrEventNameBlank = "must not be blank";
const abtoErrEventNameNul = "must not contain U+0000";
const abtoErrEventNameDollarPrefix = "must not start with \$";
const abtoErrEventNameReserved = "must not use an ABTO system event name";
const abtoErrEventNameTooLong = "must be at most 200 UTF-16 code units";
const abtoErrEventDropped = "[abto] event was dropped: {issue}.";
const abtoErrCustomCaptureInvalid = "[abto] custom event was dropped: optional value and scale must satisfy the collector contract; properties must contain JSON values and no reserved keys.";
const abtoErrMetricValueOmitted = "[abto] metric value is outside the collector contract and was omitted.";
const abtoErrMetricScaleOmitted = "[abto] metric scale is outside the collector contract and was omitted.";
